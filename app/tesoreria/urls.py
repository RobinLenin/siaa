...
urlpatterns = [
    ...
    path('cuenta_cobrar/guardar2', views.cuenta_cobrar_guardar, name='cuenta_cobrar_guardar2'),
    path('cuenta_cobrar/guardar2/<int:id>', views.cuenta_cobrar_guardar, name='cuenta_cobrar_guardar2'),
